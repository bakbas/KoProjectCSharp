...
if(EVENT == 193 ) then
	SelectMsg(UID, 2, -1, 9289, NPC, 10, 5 )
end

if(EVENT == 104) then --Warrior
	LEVEL = GetLevel(UID)
	COIN = HowmuchItem(UID, 900000000);  
	Warrior1Slot = CheckGiveSlot(UID, 6)
	if Warrior1Slot == false then
	SelectMsg(UID,2,-1,8900,NPC,10,1000)
	else
	if( LEVEL > 59 and COIN > 29999999 ) then
		GiveItem(UID, 205001016, 1, 1)
		GiveItem(UID, 205002016, 1, 1)
		GiveItem(UID, 205003016, 1, 1)
		GiveItem(UID, 205004016, 1, 1)
		GiveItem(UID, 205005016, 1, 1)
		GiveItem(UID, 205001016, 1, 1)
...
if(EVENT == 105) then
	LEVEL = GetLevel(UID)
	COIN = HowmuchItem(UID, 900000000);  
		Rogue1Slot = CheckGiveSlot(UID, 6)
	if Rogue1Slot == false then
	SelectMsg(UID,2,-1,8900,NPC,10,1000)
	else
...
if(EVENT == 124) then -- Mage
	LEVEL = GetLevel(UID)
	COIN = HowmuchItem(UID, 900000000);  
		RoguecSlot = CheckGiveSlot(UID, 8)
	if RoguecSlot == false then
	SelectMsg(UID,2,-1,8900,NPC,10,1000)
	else
	if( LEVEL > 59 and COIN > 29999999 ) then
		GiveItem(UID, 981110570, 1, 1);
		GiveItem(UID, 981110571, 1, 1);
		GiveItem(UID, 981110547, 1, 1);
		GiveItem(UID, 966001558, 1, 1);
		GiveItem(UID, 966002559, 1, 1);
		GiveItem(UID, 966003560, 1, 1);
		GiveItem(UID, 966004561, 1, 1);
		GiveItem(UID, 966005562, 1, 1);
		GoldLose(UID, 30000000);
	else              
		SelectMsg(UID, 2, -1, 8893, NPC, 4466, 106, 3019, 193 )
	end
...
if(EVENT == 125) then
	LEVEL = GetLevel(UID)
	COIN = HowmuchItem(UID, 900000000);  
	   RoguecasSlot = CheckGiveSlot(UID, 8)
	if RoguecasSlot == false then
	SelectMsg(UID,2,-1,8900,NPC,10,1000)
	else
	if( LEVEL > 35 and LEVEL < 60 and COIN > 29999999 ) then
...
if(EVENT == 134) then -- Priest
	LEVEL = GetLevel(UID)
	COIN = HowmuchItem(UID, 900000000);  
	RoguecaasSlot = CheckGiveSlot(UID, 7)
	if RoguecaasSlot == false then
	SelectMsg(UID,2,-1,8900,NPC,10,1000)
	else
	if( LEVEL > 59 and COIN > 29999999 ) then
