...
if (EVENT == 100) then
	SelectMsg(UID, 3, -1, 9138, NPC, 7255, 200, 7316, 300, 8430, 500, 8915, 1600);
end
...
if (EVENT == 300) then -- [Spirit Alseids] Of mounting
	SelectMsg(UID, 2, 0, 9136, NPC, 7316, 301);
end

if (EVENT == 301) then -- [Spirit Alseids] Of mounting
	SelectMsg(UID, 2, 0, 9131, NPC, 10, 302);
end
...
if( EVENT == 1600) then
	Level = CheckLevel(UID);
	if (Level < 35) then
		SelectMsg(UID, 2, -1, 9126, NPC, 4161, 1601, 4162, 241);
	elseif (Level > 34 and Level < 61) then
		SelectMsg(UID, 2, -1, 9127, NPC, 4161, 1601, 4162, 241);
	elseif (Level > 60) then
		SelectMsg(UID, 2, -1, 9128, NPC, 4161, 1601, 4162, 241);
	end
end
...
if( EVENT == 1601) then
	...
	if (Level < 35) then
		...
		CastSkill(UID, 302328)
		CastSkill(UID, 107010)
	elseif (Level > 34 and Level < 61 and NOAH < 120000) then
		SelectMsg(UID, 2, -1, 9127, NPC, 4161, 1606, 4162, 241);
	elseif (Level > 60 and NOAH > 199999) then
		SelectMsg(UID, 2, -1, 9128, NPC, 4161, 1605, 4162, 241);
	end
end
